...
function showDog() {
    ...
    // document.querySelector('img').imgSource = "https://kb.rspca.org.au/wp-content/uploads/2018/11/golder-retriever-puppy.jpeg"
};
...
function showFish() {
    ...
    document.querySelector("#image-demo").src = "https://spca.bc.ca/wp-content/uploads/fish-discus-swimming.jpg"
};
